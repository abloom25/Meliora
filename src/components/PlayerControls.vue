...
<template>
  <div class="controls" :class="`is-${variant}`">
    ...
    <div v-if="variant === 'mini'" class="mini-buttons">
      <button class="control-button" aria-label="上一首" @click="onPrevious"><SkipBack :size="19" fill="currentColor" /></button>
      ...
      <button class="control-button" aria-label="下一首" @click="onNext"><SkipForward :size="19" fill="currentColor" /></button>
    </div>
  </div>
</template>
