...
export type { ThemeColor } from '../../core/theme/palette'
export { createThemeColor } from '../../core/theme/palette'
...
function getWorker(): Worker | null {
  ...
  try {
    workerInstance = new Worker(
      new URL('../../workers/theme-extractor.worker.ts', import.meta.url),
      {
        type: 'module',
      },
    )
